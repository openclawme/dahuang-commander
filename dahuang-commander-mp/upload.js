...
const desc = '1. 全站换肤彻底补完：清除最后 67 处荧光青/灰蓝/白边/蓝紫渐变残留（注册表单、滑杆、开关、帖子卡片、评论按钮全部统一水墨色板）\n2. 元神法印页布局重构：当前元神卡分为身份区/凭证区/操作区，DID 截断显示+点击复制，Karma 并入身份区；预设性格卡片与滑杆统一朱砂选中态；服务器配置与语言切换合并为一个卡片；日志面板去除等宽字体\n3. 大荒之地页微调：评论发送按钮改朱砂渐变，战报按钮纸白花青，印章彩色发光统一墨色投影';
